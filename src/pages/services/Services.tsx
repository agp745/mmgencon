export function Services() {
  return (
    <main className="text-slate-100">
      <section className="mt-20 flex min-h-screen flex-col items-center justify-center gap-20 bg-slate-900 bg-cover">
        ...
        <div className="flex w-[80%] flex-col items-center gap-10 pb-10 text-center">
          ...
          <div className="mt-2 flex flex-col items-center justify-center border-2 border-black bg-blue-100/90 p-5 text-4xl font-light tracking-widest text-black">
            ...
            <p className="mt-10 text-xl font-light tracking-wide">
      ...
      <section className="flex min-h-screen flex-col items-center justify-center gap-20 bg-slate-800 bg-contain">
        <div className="mt-2 flex flex-col items-center border-2 border-black bg-slate-100/90 p-5 text-center text-4xl font-light tracking-widest text-black">
          <h1>Commercial Services</h1>
          <p className="text-xl tracking-wide">Our on-site management crews are ready to serve you</p>
        </div>
        <div className="flex w-[80%] flex-col items-center gap-10 pb-10 text-center">
          <p className="w-2/3 text-3xl font-semibold text-slate-100">
          ...
          {/* <p className="p-3 text-2xl">
            Our on-site management crews are ready to serve you.
          </p> */}
